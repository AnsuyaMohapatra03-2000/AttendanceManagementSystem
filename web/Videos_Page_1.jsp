...
<%  System.out.println("************ Starting of Video Page 1 ******************"); %>
<%! String src; int halfTime; String topic;
%>
<%
    String subClicked = (String) session.getAttribute("subClicked");
    session.setAttribute("videoNo","1");
    System.out.println("I am inside video page of 1 st lecture n i m watching lectures of :" +subClicked);
     
    if(subClicked.equalsIgnoreCase("iwt1")){
        src = "videos/IWT_1.mp4";
        halfTime = 242;
        topic = "Introduction to html tutorial for beginners";
        System.out.println("video 1 :" + src);
    }
    else if(subClicked.equalsIgnoreCase("dccn1")){
        src = "videos/DCCN_1.mp4";
           halfTime = 290;
           topic = "Introduction to Computer Networks";
        System.out.println("video 1 :" + src);
    }
    else if(subClicked.equalsIgnoreCase("os1")){
        src = "videos/OS_1.mp4";
           halfTime = 544;
            topic = "Basics of operating system";
        System.out.println("video 1 :" + src);
    }
%>
<script>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header ">
                                    <h4 class="card-title"> LECTURE - 01 </h4>
                                </div>
                                <div class="card-body">
...
<%  System.out.println("************ Ending of Video Page 1 ******************"); %>
</body-->
</html>
