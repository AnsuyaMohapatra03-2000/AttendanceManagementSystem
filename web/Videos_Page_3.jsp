...
<%  System.out.println("************ Starting of Video Page 3 ******************"); %>
<%! String src; int halfTime;String topic;%>
<%
    String subClicked = (String) session.getAttribute("subClicked");
    session.setAttribute("videoNo","3");
    System.out.println("I am inside video page of 1 st lecture n i m watching lectures of :" +subClicked);
     
    if(subClicked.equalsIgnoreCase("iwt3")){
        src = "videos/IWT_3.mp4";
          halfTime = 154;
          topic = "Java In 5 Minutes - What Is Java - Java Programming For Beginners - Learn Java ";
        System.out.println("video 1 :" + src);
    }
    else if(subClicked.equalsIgnoreCase("dccn3")){
        src = "videos/DCCN_3.mp4";
          halfTime = 264;
           topic = "Classification of Computer Networks";
        System.out.println("video 1 :" + src);
    }
    else if(subClicked.equalsIgnoreCase("os3")){
        src = "videos/OS_3.mp4";
          halfTime = 536;
           topic = "Multithreading models and hyper threading";
        System.out.println("video 1 :" + src);
    }
%>
<script>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header ">
                                    <h4 class="card-title"> LECTURE - 03 </h4>
                                </div>
                                <div class="card-body">
...
<%  System.out.println("************ Ending of Video Page 3 ******************"); %>
</body-->
</html>
